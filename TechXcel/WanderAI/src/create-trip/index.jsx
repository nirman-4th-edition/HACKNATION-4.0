  ...
  return (
    <div className="px-5 mt-12 sm:px-10 md:px-32 lg:px-56 xl:px-72">
      <div>
        ...
        <p className="mt-3 text-gray-600 text-xl">JSimply share some essential details, and our advanced trip planner will craft a bespoke itinerary meticulously tailored to your unique preferences.</p>
      </div>

      <div className="mt-20 flex flex-col gap-10 ">
        <div className="mb-5">
          <label className="text-xl mb-3 font-medium">What Will be Your Destination 📍🗺️ ?</label>
          <Input
        ...
        <div className="mb-5">
          <label className="text-xl font-medium">What is the duration of your planned trip ?📆 </label>
          <Input placeholder={'ex.3 ( N.B: Value<5)'} type='number' min="1"
