...
const [formInput, setFormInput] = useReducer(
    ...
    return (
      <div>
        <h1>......</h1>
        <h1>Aga Khan Palace</h1>
        <a href="https://artsandculture.google.com/streetview/aga-khan-palace/GAE87qU8utcOaw?sv_lng=73.90173341049064&sv_lat=18.55277596497143&sv_h=205&sv_p=15&sv_pid=83R0RwfaCYKIpSQ5bcNjTw&sv_z=1"><h6>View 360!</h6></a>
        <br></br>
...
<br></br>
  ...
  <tbody>
    <tr>
      <td>Rs. 5 for Adults</td>
      <td rowSpan={2}>Rs 100</td>
      
    </tr>
    <tr>
      
      <td>2 rupees for Children below 15 years</td>
            ...
            <li><h1>	
&#128231;</h1>
                    <p> <a href="https://www.mkgandhi.org/gandhiyatra/agakhan.htm">Visit Website</a></p>
            </li>
            </ul>
        </div></Col>
  ...
  <div className="App">
      <div className="input-container">
        <div>
          ...
          <input type="hidden" name="monument" value="Aga Khan Palace"/>
          <input type="hidden" name="price_adult" value="5"/>
          <input type="hidden" name="price_children" value="2"/>
          <input type="hidden" name="price_abroad" value="100"/>
        </div>
