...
import img1 from './RajaDinkarKelkarMuseum.jpg'
...
const [formInput, setFormInput] = useReducer(
    ...
    {
      "city": "PUNE",
      "monument": "Raja Dinkar Kelkar Museum",
      "price_adult":"50",
      "price_children":"10",
      "price_abroad":"200",
      "name": "string",
    ...
    return (
      <div>
        <h1>......</h1>
        <h1>Raja Dinkar Kelkar Museum</h1>
        <br></br>
...
<br></br>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>10 rupees for Children below 15 years</td>
            ...
            <li><h1><div class="marker"></div></h1>
                    <p>1377-78, Natu Baug, Off. Bajirao Road, Chavhan Road, Mandai, Shukrawar Peth, Pune</p>
            </li>
            ...
            <li><h1>	
&#128231;</h1>
                    <p> <a href="https://punetourism.co.in/raja-dinkar-kelkar-museum-pune">Visit Website</a></p>
            </li>
            </ul>
        </div></Col>
  ...
  <div className="App">
      <div className="input-container">
        <div>
          ...
          <input type="hidden" name="monument" value="Raja Dinkar Kelkar Museum"/>
