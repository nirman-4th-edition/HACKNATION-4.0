...
import img1 from './Hawa_Mahal.jpg'
    ...
    <tr>
      ...
      <td>Free for Children below 15 years</td>
            ...
            <li><h1><div class="marker"></div></h1>
                    <p>Hawa&nbsp;Mahal&nbsp;Rd,&nbsp;Badi&nbsp;Choupad,&nbsp;J.D.A.&nbsp;Market, Pink&nbsp;City,&nbsp;Jaipur,&nbsp;Rajasthan,&nbsp;302002,&nbsp;India </p>
            </li>
            ...
            <li><h1>	
&#128231;</h1>
                    <p> <a href="https://jaipurtourism.co.in/hawa-mahal-jaipur">Visit Website</a></p>
  ...
  <div className="App">
      <div className="input-container">
        <div>
          ...
          <input type="hidden" name="monument" value="Hawa Mahal"/>
