...
import img1 from './jantar_mantar.jpg'
...
const [formInput, setFormInput] = useReducer(
    ...
    return (
      <div>
        <h1>......</h1>
        <h1>Jantar Mantar</h1>
        <a href="https://artsandculture.google.com/streetview/jantar-mantar/aQFnq5vufZHumw?sv_lng=77.21638324700638&sv_lat=28.62737511426135&sv_h=7.5&sv_p=11&sv_pid=mUQAYNWAyoKBkx6qXeckeg&sv_z=1"><h6>View 360!</h6></a>
        <br></br>
    ...
    <tr>
      ...
      <td>Free for Children below 15 years</td>
            ...
            <li><h1><div class="marker"></div></h1>
                    <p>Gangori Bazaar, J.D.A. Market, Kanwar Nagar, Jaipur, Rajasthan, 302002, India </p>
            </li>
            ...
            <li><h1>	
&#128231;</h1>
                    <p> <a href="https://jaipurtourism.co.in/jantar-mantar-jaipur">Visit Website</a></p>
  ...
  <div className="App">
      <div className="input-container">
        <div>
          ...
          <input type="hidden" name="monument" value="Jantar Mantar"/>
          <input type="hidden" name="price_adult" value="50"/>
          <input type="hidden" name="price_children" value="0"/>
          <input type="hidden" name="price_abroad" value="200"/>
        </div>
