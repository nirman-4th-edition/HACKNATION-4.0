...
<br></br>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> FOR CHILDREN BELOW 5 YEARS - Rs.20/-</td>
            ...
            <li><h1><div class="marker"></div></h1>
                    <p> 27, Jawaharlal Nehru Road, Park Street,
Kolkata - 700016. W.B.</p>
            </li>
            ...
            <li><h1>	
&#128231;</h1>
                    <p> <a href="https://indianmuseumkolkata.org/">Visit Website</a></p>
            </li>
            </ul>
        </div></Col>
  ...
  <div className="App">
      <div className="input-container">
        <div>
          ...
          <input type="hidden" name="monument" value="Indian Museum"/>
          <input type="hidden" name="price_adult" value="50"/>
          <input type="hidden" name="price_children" value="20"/>
