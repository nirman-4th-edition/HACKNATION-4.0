...
import img1 from './victoriamemorial.jpg'
    ...
    <tr>
      ...
      <td> FREE FOR CHILDREN BELOW 11 YEARS</td>
            ...
            <li><h1><div class="marker"></div></h1>
                    <p>Jawaharlal Nehru Road, Kolkata</p>
            </li>
            ...
            <li><h1>	
&#128231;</h1>
                    <p> <a href="https://www.victoriamemorial-cal.org/home/content/en">Visit Website</a></p>
            </li>
            </ul>
        </div></Col>
  ...
  <div className="App">
      <div className="input-container">
        <div>
          ...
          <input type="hidden" name="monument" value="Victoria Memorial"/>
          <input type="hidden" name="price_adult" value="30"/>
