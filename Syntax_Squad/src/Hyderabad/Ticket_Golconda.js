...
import img1 from './GolcondaFort.png'
    ...
    <tr>
      ...
      <td>Free for Children below 15 years</td>
            ...
            <li><h1><div class="marker"></div></h1>
                    <p> Golconda Fort Address: Ibrahim Bagh, Hyderabad, Telangana, 500008, India
            ...
            <li><h1>	
&#128231;</h1>
                    <p> <a href="https://www.hyderabadtourism.travel/golconda-fort-hyderabad">Visit Website</a></p>
            </li>
            </ul>
        </div></Col>
  ...
  <div className="App">
      <div className="input-container">
        <div>
          ...
          <input type="hidden" name="monument" value="Golconda Fort"/>
          <input type="hidden" name="price_adult" value="25"/>
          <input type="hidden" name="price_children" value="0"/>
          <input type="hidden" name="price_abroad" value="300"/>
        </div>
