...
<br></br>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Rs. 10 for Children below 12 years</td>
            ...
            <li><h1><div class="marker"></div></h1>
                    <p> Khilwat, 20-4-236, Motigalli,, Hyderabad, Telangana, 500002, India</p>
            </li>
            ...
            <li><h1>	
&#128231;</h1>
                    <p> <a href="https://www.hyderabadtourism.travel/chowmahalla-palace-hyderabad">Visit Website</a></p>
            </li>
            </ul>
        </div></Col>
  ...
  <div className="App">
      <div className="input-container">
        <div>
          ...
          <input type="hidden" name="monument" value="Chowmahalla Palace"/>
