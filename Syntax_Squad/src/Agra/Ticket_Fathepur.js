...
const [formInput, setFormInput] = useReducer(
    ...
    return (
      <div>
        <h1>......</h1>
        <h1>Fathepur Sikri</h1>
        <a href="https://artsandculture.google.com/streetview/fatehpur-sikri-buland-darwaza/BAE-z_40AwGqkQ?sv_lng=77.66269537706103&sv_lat=27.09397012587972&sv_h=20&sv_p=30.00134805588725&sv_pid=TI6Ir35Y0lSvkeynHMHGYQ&sv_z=1"><h6>View 360!</h6></a>
        <br></br>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Free for Children below 15 years</td>
            ...
            <li><h1>	
&#128231;</h1>
                    <p> <a href="https://www.tajmahal.gov.in/fatehpur-sikri.aspx">Visit Website</a></p>
            </li>
            </ul>
        </div></Col>
  ...
  <div className="App">
      <div className="input-container">
        <div>
          ...
          <input type="hidden" name="monument" value="Fathepur Sikri"/>
