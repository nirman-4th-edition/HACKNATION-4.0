  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div className="w-full max-w-4xl flex bg-gradient-to-r from-gray-800 to-gray-700 shadow-xl rounded-lg overflow-hidden">
        {/* Left Side - Sign Up */}
        <div className="w-1/2 flex flex-col items-center justify-center bg-gradient-to-br from-gray-700 to-gray-800 p-8 text-white rounded-l-lg">
          <h2 className="text-xl font-semibold">Hello!</h2>
          <p className="text-sm text-gray-300 mt-2 text-center">Enter your personal details and start the journey with us</p>
          <button className="mt-4 px-6 py-2 border border-white rounded hover:bg-white hover:text-gray-800 transition">Sign Up</button>
        </div>
